/*
# TECH — Make created_by nullable + Seed hackathons

## Changes
1. Alter hackathons.created_by to be nullable (allows seed data without an auth context)
2. Insert 6 seed hackathons across various categories
*/
